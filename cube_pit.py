...
n1 = nNNet(cube)
n1.load_checkpoint('./pretrained_models/cube-keras-colab3/', 'best3.pth.tar')
#n1.load_checkpoint('./pretrained_models/cube-keras-colab3/', 'checkpoint3_2.pth.tar')
args1 = dotdict({'numMCTSSims': 50, 'cpuct': 1.0})
mcts1 = MCTS(cube, n1, args1)
n1p = lambda x: np.argmax(mcts1.getActionProb(x, temp=0))

n2 = nNNet(cube)
n2.load_checkpoint('./pretrained_models/cube-keras-colab3/', 'best2.pth.tar')
...
#arena = cta.CubeTicTacToeArena(n2p, osp, cube, display = cube.displays)
